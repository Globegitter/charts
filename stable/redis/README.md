...
| `master.initContainers`                    | Any customer initContainer for the Redis master statefulset                                                    | []                                                   |
...
| `slave.initContainers`                     | Any customer initContainer for the Redis slave deployment                                                      | `master.initContainers`                              |
